	...
	return (
		<Container>
			<Section className="prose prose-slate max-w-lg mx-auto">
				...
				<h2>Overview</h2>
				<p>
					This website is operated by {config.websiteName}. Throughout the site,
					the terms “we”, “us” and “our” refer to {config.websiteName}.{" "}
					{config.websiteName} offers this website, including all information,
